...
export default function WorkspaceMemberProfile({ member, setMemberProfile }: { member: WorkspaceMember, setMemberProfile: (member: WorkspaceMember | undefined) => void}) {
    ...
    return (
      ...
      <div className=' flex w-full flex-col gap-5'>
        ...
        <Button size={"icon"} variant={"ghost"} onClick={() => {setMemberProfile(undefined)} }>
            <ArrowLeft size={16} />
          </Button>
        ...
        <div className=' flex w-full flex-col items-center justify-start overflow-x-scroll gap-4 text-xs'>
        ...
        <div className=' primary-surface border rounded-md flex flex-col w-full justify-between gap-2 p-2 divide-y  '>
            ...
            <div className=' primary-surface flex w-full justify-between gap-2 p-2  '>
                ...
                <span className='w-full truncate  flex-shrink-0'>{value.toString()}</span>
