      ...
      <Form {...form}>
        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='flex w-full items-center gap-2 '>
                <span className='text-2xs w-20 font-normal'>Status</span>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='flex w-full items-center gap-2 '>
                <span className='text-2xs w-20 font-normal'>Start date</span>
                <FormControl className='w-full'>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='flex w-full items-center gap-2 '>
                <span className='text-2xs w-20 font-normal'>Target date</span>
                <FormControl className='w-full'>
