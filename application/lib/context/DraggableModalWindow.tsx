...
export function DraggableModalWindow() {
  ...
  const [coordinates, setCoordinates] = useState({ x: window.innerWidth - 410, y: 10 });
  ...
  return (
    ...
    //   }}
      ...
      maxHeight={'90%'}
      maxWidth={400}
      className='z-50 bg-white dark:bg-neutral-800 h-fit flex flex-1 h-90svh flex-col gap-2 overflow-hidden  rounded-lg border border-neutral-300 px-2  pb-2  text-gray-800 shadow-sm !dark:border-neutral-700 dark:text-gray-200 overflow-y-scroll'
      allowAnyClick={true}
    >
