...
export const createTeamResolver: GraphQLFieldResolver<any, { db: Kysely<WorkspaceSchema> }> = async (
  parent: any,
  args: any,
  context,
  _
...
export const updateTeamResolver: GraphQLFieldResolver<any, { db: Kysely<WorkspaceSchema> }> = async (
  parent: any,
  args: any,
  context,
  _
...
export const deleteTeamResolver: GraphQLFieldResolver<any, { db: Kysely<WorkspaceSchema> }> = async (
  parent: any,
  args: any,
  context,
  _
...
export const teamResolver: GraphQLFieldResolver<any, { db: Kysely<WorkspaceSchema> }> = async (
  parent: any,
  args: any,
  context,
  _
      ...
      .select((eb) => [
        ...
        jsonArrayFrom(
          eb
            ...
            .select((eb) => ['project.id', 'project.name', 'project.description'])
        ).as('projects'),
      ])
      .executeTakeFirstOrThrow();
  } catch (e) {
...
export const teamsResolver: GraphQLFieldResolver<any, { db: Kysely<WorkspaceSchema> }> = async (
  parent: any,
  args: any,
  context,
  _
...
export const workspaceTeamsResolver: GraphQLFieldResolver<any, { db: Kysely<WorkspaceSchema> }> = async (
  parent: any,
  args: any,
  context,
  _
