    ...
    <ContextMenu>
      <ContextMenuTrigger>
        <div
          ...
          className='flex w-full flex-col relative py-2'
        >
          ...
          variant={'outline'}
          size={'icon'}
          className=' text-neutral-400 w-6 p-1 h-6 absolute top-0 right-0 z-10 transfrom  rounded-full  dark:border-neutral-900 dark:bg-neutral-800 dark:text-neutral-300'
          onClick={(e) => {
            e.stopPropagation();
