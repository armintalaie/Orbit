...
export function NewProject({button, reload}: {button?: boolean, reload: Function}) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      {button ? <Button variant="outline" className="p-2 text-xs m-0 h-6">New Project</Button> :  <button>
...
<FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
              <Textarea placeholder="Type your message here." id="message-2" className="h-60" {...field} />
              </FormControl>
