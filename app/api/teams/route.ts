...
export let teams: ITeam[] = [
    {
        ...
        description: "Responsible for developing and maintaining the company website.",
        status: 1,
        meta: {
    ...
    },
    {
        ...
        description: "Responsible for developing and maintaining the company mobile app.",
        status: 2,
        meta: {
